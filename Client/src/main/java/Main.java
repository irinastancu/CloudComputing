...
public class Main {
    public static void main(String[] args) {
        ...
        while(isConnected){
            System.out.println("You will have to insert your name and tin:\n");
            ...
            System.out.println("Your tin: ");
            tin=scan.next();

            UserOuterClass.InfoReply reply = bookStub.getInfo(UserOuterClass.InfoRequest.newBuilder().setName(name).setTin(tin).build());
